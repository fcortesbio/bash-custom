...
# Hyprland Configs
alias monitors="nvim ~/.config/hypr/conf/monitors/default.conf"
alias keyb="nvim ~/.config/hypr/conf/keybindings/default.conf"
alias custom-bash="nvim ~/bash-custom"

# System maintenance
alias src="source ~/.bashrc"
alias bashfuncs="nvim ~/bash-custom/"
